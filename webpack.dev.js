...
const ENTRY_PATH = pathLib.resolve(ROOT_PATH, 'server');
const OUTPUT_PATH = pathLib.resolve(ROOT_PATH, 'build');
console.log('--------',pathLib.resolve(ENTRY_PATH, 'server.js'));

console.log('---ROOT_PATH-----',ROOT_PATH);
console.log('---ENTRY_PATH-----',ENTRY_PATH);
console.log('---OUTPUT_PATH-----',ROOT_PATH);
module.exports = {
    entry: {
        index: [
            ...
            'babel-polyfill',
            pathLib.resolve(ENTRY_PATH, 'server.js')
        ],
