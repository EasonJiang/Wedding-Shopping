...
const linkComponent = (route, label, accent, click) => (
  <Link to={route} style={{ marginLeft: 40 }}>
    <Button label={label} accent={accent} raised onClick={click} />
  </Link>
);
    ...
    return (
      <AppBar leftIcon={<GithubIcon />} onRightIconClick={this.handleToggle.bind(this)} rightIcon={<MeIcon />}>
        <Navigation type='horizontal' >
          ...
          {linkComponent('/Ornaments', 'Ornaments', this.state.oAccent, () => this.setState({ hAccent: true, wAccent: true, oAccent: false, aAccent: true, }))}
